...
## ⚠️ IMPORTANT: Not Used in PostHubAPI

**This document describes CQRS (Command Query Responsibility Segregation). PostHubAPI uses a simpler Layered Architecture.**

For PostHubAPI-specific guidance, see:
